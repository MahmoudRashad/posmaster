...
public class ProductCatalog {
	 ...
	 * @return true if product adds in inventory success ; otherwise false.
	 */
	public boolean addProduct(int _id,String name, String barcode, double salePrice) {
		Product product = new Product(_id,name, barcode, salePrice);
		int id = inventoryDao.addProduct(product);
		return id != -1;
	}
	...
	/**
	 * Constructs product and adds product to inventory.
	 * @param products JSONArray as list of product.

	 * @return true if product adds in inventory success ; otherwise false.
	 */
	public boolean add_Products(JSONArray products) throws JSONException {
	 ...
	 * @return true if product adds in inventory success ; otherwise false.
	 */
	public boolean add_Products(ArrayList<Product> products) throws JSONException {
