...
public class QuickLoadSale extends Sale {
	...
	public QuickLoadSale(int id, String startTime, String endTime, String status, Double total, Integer orders) {
		...
		public QuickLoadSale(int id, String startTime, String endTime, String status, Double total, Integer orders,List<LineItem> items) {
		super(id, startTime, endTime, status, items);
		this.total = total;
		this.orders = orders;
	}
