...
public class SaleLedger {
	 ...
	 */
	public void updateSaleEnded (Sale sale) {
		 saleDao.endSale(sale, DateTimeStrategy.getCurrentTime(), Globalclass.ENDED);
	...
	/**
	 * Returns list of local Sale  .
	 * @return list of local Sale  .
	 */
	public List<Sale> getAll_local_Sale() {
		return saleDao.getAll_local_Sale();
	}
}
