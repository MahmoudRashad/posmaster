...
public class SplashScreenActivity extends Activity {
	...
	private void go() {
		gone = true;
		LoginSharedPreferences loginSharedPreferences= new LoginSharedPreferences(SplashScreenActivity.this );
//		if(loginSharedPreferences.getEmail().length()== 0)
//		{
			if(Globalclass.isNetworkAvailable(SplashScreenActivity.this)){
